        ...
        <div class="topbar-content">
            ...
            <div class="topbar-links">
                <?php if (isset($_SESSION['userid'])): ?>
                    ...
                    <a href="logout2.php">Ausloggen</a>
                <?php else: ?>
...
<header class="header">
    <div class="container">
        <div class="header-content">
            ...
            <nav class="main-nav">
                ...
                <a href="produkte/afro.html">Afrikanisch</a>
                <a href="produkte/asia.html">Asiatisch</a>
     <?php if (isset($_SESSION['userid'])): ?>
    ...
    <?php endif; ?>
            ...
            <div class="header-actions">
                <a href="produkte/warenkorb.html" class="cart-btn">
    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="produkte/index.html" class="btn btn-primary">
                    Jetzt einkaufen
                </a>
    ...
    <div class="container">
        ...
        <div class="category-grid">
            <div class="category-card featured">
                ...
                <a href="produkte/Kategorien/getreide.html" class="category-link">Entdecken →</a>
            </div>

            <div class="category-card featured">
                <h3 class="category-name">Gewürze</h3>
                <p class="category-desc">Authentische Aromen</p>
                <a href="produkte/Kategorien/gewürze.html" class="category-link">Entdecken →</a>
            </div>

            <div class="category-card featured">
                <h3 class="category-name">Getränke</h3>
                <p class="category-desc">Erfrischend & exotisch</p>
                <a href="produkte/Kategorien/getränke.html" class="category-link">Entdecken →</a>
            </div>

            <div class="category-card featured">
                <h3 class="category-name">Trockene Lebensmittel</h3>
                <p class="category-desc">Lange haltbar</p>
                <a href="produkte/Kategorien/lebensmittel.html" class="category-link">Entdecken →</a>
            </div>

            <div class="category-card featured">
                <h3 class="category-name">Soßen & Öle</h3>
                <p class="category-desc">Verfeinere deine Gerichte</p>
                <a href="produkte/Kategorien/öl.html" class="category-link">Entdecken →</a>
            </div>
        </div>
    </div>
</section>
...
// Warenkorb-Zähler beim Laden aktualisieren
function updateCartCount() {
    const ware = JSON.parse(localStorage.getItem('ware')) || [];
