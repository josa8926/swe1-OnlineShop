...
\newcommand{\modulname}{Software Engineering 1 (SWE 1)}

% Setze Dozent:in (bachelorarbeit muss false sein)
\newcommand{\auditor}{\textbf{Dozent:in:} \> Prof. Dr. Laura Bieker-Walz}
...
\newcommand{\thetitle}{Literaturzusammenfassung} 
\newcommand{\thesubtitle}{}

% Setze Autor:in und MatNr.
\newcommand{\theauthor}{Magne Tuekam }
\newcommand{\matriculationnumber}{41881}

% Abstand zwischen Name und MatNr. (siehe Deckblatt)
\newcommand{\myspace}{1.9cm}

% Muss in src/basic_structure/deckblatt.tex einkommentiert werden! 

\newcommand{\secondauthor}{\> Danielle Matcheu  \> MatNr. \\}
\newcommand{\fourthauthor}{\> Joslyno Azemgning \> MatNr. 42616\\}
\newcommand{\fifthauthor}{\> Joyce Markline Sambou Leundja\> MatNr. \\}
...
\input{src/anforderungsanalyse.tex}

%\input{src/fazit.tex}
\input{src/Zusammenfaßung.tex}
%\input{src/literaturverzeichnis.tex}
\newpage
...
%\ohead{Literaturverzeichnis}%{\leftmark} % Korrektur für Header
%\phantomsection
%\addcontentsline{toc}{section}{Literaturverzeichnis}
%\renewcommand\refname{Literaturverzeichnis}
%\printbibliography
...
%\addbibresource{hauptdatei.bib}  % Name deiner Bib-Datei

%\begin{document}

% ... dein Inhalt ohne Zitate ...

%\begin{frame}{}
%\nocite{*}  % <<--- DAS ist der wichtige Befehl
